// TODO: [imo-note] 本测试需要在 lesson8 路径下执行 `mocha` 命令
// TODO: [imo-note] 需要停止 `nodemon app.js` 起的服务，
// TODO: [imo-note] 否则，测试会有 `Uncaught Error: listen EADDRINUSE :::3000` 的 fail case
var app = require('../app');
